  ...
  chiefPatrons: [
    {
      ...
      image: "TeamMemberRobertMariaImg",
      linkedin: "https://www.linkedin.com/in/robert-maria",
    },
    {
      name: "Joseph Francis",
      role: "Founder Investor",
      ...
      linkedin: "https://www.linkedin.com/in/joseph-francis",
    },
    {
      ...
      image: "TeamMemberSilvasterAntonyImg",
  ...
  patrons: [
    {
      name: "Vivin Silva",
      role: "Director",
      image: "TeamMemberVivinSilvaImg",
      linkedin: "https://www.linkedin.com/in/vivin-silva",
    },
    {
      name: "Rifin Silva",
      role: "Director",
      image: "riffin_passport",
  ...
  team: [
    {
      ...
      image: "TeamMemberRitikaJhagtaImg",
      linkedin: "https://www.linkedin.com/in/ritika-jhagta-a653a4128",
    },
    {
      name: "Kislay Tripathi",
      role: "System Engineer",
      image: "TeamMemberKislayTripathiImg",
      linkedin: "https://www.linkedin.com/in/kislay-tripathi",
    },
    {
      name: "Neteti Teja",
  ...
  advisors: [
    {
      ...
      image: "TeamMemberAravindVaidyanathanImg",
    ...
    },
    {
      ...
      image: "TeamMemberPriyadarshnamHariImg",
...
const TeamMemberCard = ({ member }) => (
  <div className="w-full h-[644px] bg-[#1D313C] bg-[linear-gradient(to_bottom,_#1D313C_40%,_#1A1A1A_40%)] rounded-[15px] flex flex-col justify-around items-center py-4 px-6">
    <div className="flex flex-col items-center gap-[3.9px]">
      <p className="font-roboto font-medium text-[23px] text-[#F9EFEC]">{member.name}</p>
      <p className="font-roboto font-normal text-[17px] text-[#B3B3B2]">{member.role}</p>
      {member.description && (
